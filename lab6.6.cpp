/*
writing the question over and over again
...
int sumSquareOddNumbers(int firstNum,int secondNum)
{
	int sum=0;
	int j=firstNum;
	while(j<=secondNum)//(use while loop)
	{
		if(j%2==1)
		{
			sum=sum+(j*j);
...
int main()//Write a main program.
{
	...
	*/
	...
	display the values.
	*/
	cout<<"The sum of the even numbers in between the two entered numbers is "<<sumEven<<endl;
	cout<<"The sum of the odd numbers in between the two entered numbers is "<<sumOdd<<endl;
	cout<<"The sum of the square of the even numbers in between the two entered numbers is "<<sumSquareEven<<endl;
	cout<<"The sum of the square of the odd numbers in between the two entered numbers is "<<sumSquareOdd<<endl;
	return 0;
}
